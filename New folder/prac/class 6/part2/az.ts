...
// console.log(numa + num1 * num2) // 9120
// console.log(num1 * num1 + numa) //1449
// console.log(num1 + numa * num2) // 1290. // iska answer 82 kyun arha hai?
// 10 + "6" = 106 
...
//exponentiation
console.log(2 ** num1) //144


console.log(numa + 2 ** 3) //98
console.log(2 ** 3 + numa) //89
console.log(2 ** 3 + numa + 2**2) //894
