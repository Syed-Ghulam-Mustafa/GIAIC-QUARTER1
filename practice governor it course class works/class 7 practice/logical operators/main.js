...
let height1 = 5.5;
let height2 = 5;
//console.log('height1>height2', height1>height2); //true // , b && ki tarah hi kam krta h same.
// less than operator
...
const fries3 = false;
const fries4 = true;
const thatonedeal = meal3 && drink3 && fries3; // true && false = false ans.
//console.log(thatonedeal); // false
const thatthatdeal = meal3 && drink3 && fries4; // true && true = true ans.
